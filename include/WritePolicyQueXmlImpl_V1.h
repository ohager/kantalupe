#ifndef WRITEPOLICYQUEXMLIMPL_V1_H
#define WRITEPOLICYQUEXMLIMPL_V1_H
...
/**
  ...
  @author O. Haeger
  */
class WritePolicyQueXmlImpl_V1 : public AbstractTreeModelVisitor
{
public:
	WritePolicyQueXmlImpl_V1();
	...
	// void writeItem(const Category &); unsupported by target format
...
#endif // WRITEPOLICYQUEXMLIMPL_V1_H
