...
/******************************* ADD NOTE ***********************************
	The code remains nearly original. The only exception is, that
	formatting properties has changed, since I'd like to have
	another style.
    ...
    : QSyntaxHighlighter(parent)
{
	...
	*/
	...
	/* own style */
	m_numberFormat.setForeground(Qt::darkGray);
	m_stringFormat.setForeground(Qt::darkGreen);
	m_typeFormat.setForeground(Qt::darkMagenta);
	...
	m_labelFormat.setForeground(Qt::darkGray);
	m_labelFormat.setFontUnderline(true);

	m_commentFormat.setForeground(Qt::darkRed);

	m_preProcessorFormat.setForeground(Qt::black);
